...
\input{Kapitel Lichtschranke/Zielsetzung der Implementierung}
\input{Kapitel Lichtschranke/Analyse der Parametrierung des Lichtgatters}
\input{Kapitel Lichtschranke/Komponentenuebersicht und Systemaufbau}
\input{Kapitel Lichtschranke/Implementierung der Sicherheitslogik in der SPS}
\input{Kapitel Lichtschranke/Visualisierung auf dem HMI}