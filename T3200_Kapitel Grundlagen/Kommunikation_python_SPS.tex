...
Innerhalb der Steuerungsebene wird der Hauptprozess mithilfe von verknüpften Ein- und Ausgangssignalen gesteuert. Die IT- bzw. Softwareebene ermöglicht hingegen einen gezielten Austausch und die Verarbeitung von Informationen, beispielsweise die Verwaltung von Lagerdaten oder Aufträgen\cite{TCP}.\\
...
Durch die Übergabe dieser Informationen kann ein dynamisches und automatisiertes Handling von Prozessen realisiert werden\cite{TCP}.
...
Serielle Schnittstellen werden häufig für die direkte Anbindung von Geräten wie Scannern verwendet. Für die Kommunikation zwischen einer Programmanwendung und der SPS wird in der Regel eine netzwerkbasierte Kommunikation über Ethernet eingesetzt. Diese ermöglicht einen schnellen und flexiblen Datenaustausch zwischen mehreren Systemteilnehmern\cite{TCP}.
...
Snap7 basiert auf dem S7-Kommunikationsprotokoll und ermöglicht es, von externen Anwendungen – beispielsweise in Python – direkt auf Speicherbereiche der SPS zuzugreifen\cite{snap7}.\\
...
Durch die Nutzung von Snap7 kann eine Programmanwendung gezielt Variablen innerhalb der SPS setzen oder auslesen. Dies ermöglicht beispielsweise das Starten eines Prozesses auf Basis eines eingelesenen Scanwertes\cite{snap7}.\\
...
Die Verwendung solcher Protokolle ermöglicht eine klare Trennung zwischen Steuerungslogik und Datenverarbeitung. Während die SPS für die zeitkritische Anlagensteuerung verantwortlich ist, übernimmt die externe Software komplexe Datenverarbeitungsaufgaben\cite{snap7}.\\
