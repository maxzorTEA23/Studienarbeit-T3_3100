...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Vergleich von Barcode- und QR-Code-Systemen}
	\label{tab:Codes}
\end{table}
...
\begin{figure}[H]
	...
	\caption{Kamerabasierter Scanner; Quelle}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Vergleich der Schnittstellen RS232 und USB}
	\label{tab:schnittstellen}
\end{table}

Aus Tabelle \ref{tab:schnittstellen} wird deutlich, dass beide Schnittstellen ihre Berechtigung im industriellen Umfeld besitzen. Während RS232 besonders durch seine einfache und robuste Struktur überzeugt, bietet USB eine höhere Datenübertragungsrate und wird häufig durch virtuelle COM-Ports in bestehende Systeme integriert.\\
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Vorteile des Einsatzes von Scannern in automatisierten Systemen}
