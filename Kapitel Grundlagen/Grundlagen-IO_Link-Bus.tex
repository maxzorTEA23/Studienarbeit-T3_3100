...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{images/Topologien}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3.5cm}|p{3.5cm}|p{3.5cm}|p{3.5cm}|}
		...
		\textbf{Topologie} & Linie, Stern & Linie, Stern, Ring & Linie, Baum \\ \hline
		\textbf{Übertragungsart} & Ungeschirmte Standardleitung (3-adrig) & Ethernet-Kabel (Cat 5/6) & Geschirmtes Twisted-Pair-Kabel \\ \hline
		\textbf{Kommunikations- rate} & 4{,}8 / 38{,}4 / 230{,}4\,kBaud & bis 100\,Mbit/s & bis 12\,Mbit/s \\ \hline
		\textbf{Kommunikations- Richtung} & Bidirektional & Bidirektional & Halbduplex \\ \hline
		\textbf{Adressierung} & Automatische Geräteidentifikation (IODD) & IP-Adresse / Gerätetyp & Manuelle Geräteadresse \\ \hline
		\textbf{Einsatzebene} & Sensor-/Aktor-Ebene (Feldebene) & Steuerungs- und Leitebene & Feld- und Steuerungsebene \\ \hline
		\textbf{Diagnosefähig- keit} & Umfassend (Gerätestatus, Parametrierung, Fehlerdiagnose) & Hoch (Netzwerkdiagnose, Gerätediagnose) & Mittel (Telegrammfehler, Gerätefehler) \\ \hline
		\textbf{Verdrahtungs- aufwand} & Sehr gering & Mittel & Hoch \\ \hline
		\textbf{Integration in SPS-Systeme} & Über IO-Link-Master (Gateway) & Direkt (z.\,B. TIA Portal) & Über DP-Schnittstelle \\ \hline
		...
		\textbf{Standardisierung} & IEC~61131-9 & IEC~61158 / IEEE~802.3 & IEC~61158 \\ \hline
	\end{tabular}
