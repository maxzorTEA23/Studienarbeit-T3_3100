...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{flushleft}
			{\fontsize{12pt}{14pt}\selectfont
				\begin{tabular}{ll}
					Abgabedatum:					& \quad 09.01.2026 \\
					Bearbeitungszeitraum:		   	& \quad 16.10.2025 - 08.01.2026    \\ 
					Matrikelnummer: 			& \quad 3960407/5732737 \\ 
					Kurs: 							& \quad TEA 23 \\
					% entfällt bei Studienarbeit
					Betreuerin / Betreuer:  & \quad Prof. Dr. Ing. Thorsten Kever \\ % Betreuerin / Betreuer der Arbeit
		...
		\end{flushleft}
		\begin{flushright}
			{\fontsize{11pt}{13pt}\selectfont \copyright{} 2026 }
		\end{flushright}
	\end{titlepage}
	
\clearpage
\input{Kapitel Einleitung/erklaerung.tex}
\clearpage
\input{Kapitel Einleitung/Abstract.tex}
\clearpage
...
\clearpage
\input{Kapitel Lichtschranke/Lichtschranke.tex}
\clearpage
\input{Kapitel Umlagerung/Umlagerung.tex}
